<template>
 <div>
   <el-card class="box-card" id = "box-card">
     ...
     <div class="text item">
     	<el-row>
     	  <el-col :span="22" > <h4>命令</h4></el-col>
       ...
       <canvas-code name ="012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"></canvas-code>
   ...
   <el-card class="box-card" id = "box-card">
    ...
    <cmd-dig-add :cmdDialogFormVisible = 'cmdDialogFormVisible' v-on:close = "closed" v-on:sure = "sure('cmd')"></cmd-dig-add>
 </div>
</template>
